...
namespace SonDepremlerUI
{
    public partial class FrmSonDepremler : Form
    {
        ...
        {
            MessageBox.Show(
                @"Son Depremler programıyla; Boğaziçi Üniversitesi, Kandilli Rasathanesi ve Deprem Araştırma Enstitüsü (KRDAE) aracılığıyla sağlanan deprem verilerini istediniz zaman aralıklarında görebilirsiniz." +
                Environment.NewLine + Environment.NewLine +
                @"Ayrıca, ilgili deprem(ler)e tıklayarak mevcut tarayıcınızda depremin olduğu yeri Google Haritalar sayfasında görüntüleyebilirsiniz.",
